...
<div class="container mt-4 mb-5">
	...
	<?php if ($request): ?>
		<div class="card mb-4">
			<div class="card-body">
				...
				<div class="row g-2">
					...
					<div class="col-md-6"><strong>Marked Done By Staff At:</strong> <?php echo htmlspecialchars($request['resolved_at'] ?? 'Not yet marked done'); ?></div>
		...
		<?php if ($request['status'] === 'resolved'): ?>
			<div class="card">
				<div class="card-body">
					<h3 class="h6 fw-bold mb-3">Confirm Completion</h3>
					<p class="text-secondary mb-3">If the maintenance work is finished to your satisfaction, mark this request as completed.</p>
					<form method="post">
